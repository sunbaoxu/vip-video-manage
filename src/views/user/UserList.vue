  ...
  <section class="user-list-wrap">
    ...
    <el-row>
      <el-table :data="userArr" border max-height="500">
        <el-table-column label="用户ID" min-width="140"  >
          <template slot-scope="scope">
            <router-link :to="'/user/userDetail?pid='+scope.row.pid" class="lb-table-text">{{scope.row.pid}}</router-link>
          </template>
        </el-table-column>
        <el-table-column prop="phone" label="手机号" min-width="120" />
        <el-table-column prop="realName" label="注册时间" min-width="100" />
        <el-table-column prop="cerNo" label="用户来源" min-width="200" />
        <el-table-column prop="accStatus" label="VIP状态" min-width="100" />
        <el-table-column prop="creditAuthStatusName" label="VIP类型" min-width="110" />
        <el-table-column prop="registerTime" label="VIP开通时间" min-width="200" />
        <el-table-column prop="registerTime" label="VIP到期时间" min-width="200" />
      </el-table>
      <el-pagination
